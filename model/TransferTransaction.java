...
public class TransferTransaction extends Transaction
{
	...
	public void processTransaction(Properties props)
	{
		...
		try
		{
			...
			source.subscribe("UpdateStatusMessage", this);
			...
			else
			{
				...
				dest.subscribe("UpdateStatusMessage", this);
				...
				else
				{
					...
					if (ok == true)
					{
						...
						source.stateChangeRequest("Update", "");
						dest.stateChangeRequest("Update", "");
	...
	protected View createView()
	{
		...
		if (localView == null)
		{
				...
				localView.subscribe("DoTransfer", this);
				localView.subscribe("CancelTransfer", this);
